...
| `remoteRetryDelaySeconds` | integer; default `2` | Fixed delay before each remote SSH retry, from `0` through `600` seconds. Cancellation interrupts the delay immediately. |
