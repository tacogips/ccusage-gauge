...
- Formula: unsigned tarballs containing `bin/ccusage-gauge`.
...
```text
dist/homebrew/ccusage-gauge-<version>-darwin-arm64.tar.gz
dist/homebrew/ccusage-gauge-<version>-darwin-arm64.tar.gz.sha256
dist/homebrew/ccusage-gauge-<version>-darwin-x64.tar.gz
dist/homebrew/ccusage-gauge-<version>-darwin-x64.tar.gz.sha256
```
...
```bash
scripts/render-homebrew-formula.sh <version> ../homebrew-tap/Formula/ccusage-gauge.rb
```
...
dist/homebrew-cask/ccusage-gauge-<version>-darwin-arm64.dmg.sha256
dist/homebrew-cask/ccusage-gauge-<version>-darwin-x64.dmg
dist/homebrew-cask/ccusage-gauge-<version>-darwin-x64.dmg.sha256
```

Render the Cask:

```bash
scripts/render-homebrew-cask.sh <version> ../homebrew-tap/Casks/ccusage-gauge.rb
```
...
```bash
ruby -c Formula/ccusage-gauge.rb
brew audit --strict ccusage-gauge || brew audit --strict --formula ccusage-gauge
